    ...
    return (
      <div key={res.id} className="bg-white border rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow flex flex-col">
        <div className="flex justify-between items-start mb-4 border-b pb-4">
          ...
          <span className={`text-xs font-semibold px-2 py-1 rounded ${isUpcoming ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}>
        ...
        <Link href={`/reservations/${res.id}`} className="mt-auto">
